...
var ErbConnectGlobalNavApplicationCustomizer = /** @class */ (function (_super) {
    __extends(ErbConnectGlobalNavApplicationCustomizer, _super);
    function ErbConnectGlobalNavApplicationCustomizer() {
        ...
        _this._render = function () {
            if (!_this._topPlaceholder) {
                _this._topPlaceholder = _this.context.placeholderProvider.tryCreateContent(PlaceholderName.Top, { onDispose: _this._onDispose });
            }
...
export default ErbConnectGlobalNavApplicationCustomizer;
